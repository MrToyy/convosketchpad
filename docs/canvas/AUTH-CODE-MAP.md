...
| OpenClaw 本机/远程模式、设备身份、签名和服务端 Token 存储 | [`server/lib/agent-backends/adapters/openclaw/gateway-client-identity.ts`](../../server/lib/agent-backends/adapters/openclaw/gateway-client-identity.ts)、[`device-identity.ts`](../../server/lib/agent-backends/adapters/openclaw/device-identity.ts) | [`device-identity.test.ts`](../../server/lib/agent-backends/adapters/openclaw/device-identity.test.ts)、[`gateway-rpc.ts`](../../server/lib/agent-backends/adapters/openclaw/gateway-rpc.ts) |
