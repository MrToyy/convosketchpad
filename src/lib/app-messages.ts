...
export const appCopy = {
  'zh-CN': {
    ...
    status: {
      states: {
        connected: 'Agent Backend 已连接',
        connecting: 'Agent Backend 连接中',
        reconnecting: '正在刷新 Agent Backend 状态',
        disconnected: 'Agent Backend 未连接',
      },
      branches: '分支',
      working: '工作中',
      context: '上下文',
    ...
    restart: {
      title: '重启 Agent Backend',
      message: 'Backend 重启期间，正在进行的 Canvas 交互可能会重新连接。',
      confirm: '重启',
      success: 'Backend 已成功重启',
      failed: 'Backend 重启失败',
    },
    usage: {
      heading: '用量',
  ...
  en: {
    ...
    status: {
      states: {
        ...
        connecting: 'Connecting to Agent Backend',
        reconnecting: 'Refreshing Agent Backend status',
        disconnected: 'Agent Backend disconnected',
      },
      branches: 'branches',
      working: 'working',
      context: 'Context',
    ...
    restart: {
      ...
      message: 'Active Canvas interactions may reconnect while the Backend restarts.',
      confirm: 'Restart',
      success: 'Backend restarted successfully',
      failed: 'Backend restart failed',
    },
    usage: {
      heading: 'Usage',
      loading: 'Loading…',
