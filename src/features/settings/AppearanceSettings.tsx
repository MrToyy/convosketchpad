...
export function AppearanceSettings() {
  ...
  const rows = [
    ...
    { icon: Monitor, label: copy.theme, hint: copy.themeHint, value: theme, onChange: (value: string) => setTheme(value as ThemeName), options: themeNames.map((name) => ({ value: name, label: themes[name].label })), aria: copy.themeAria },
