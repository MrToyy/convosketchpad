...
export function TopBar({ onSettings, tokenData }: { onSettings: () => void; tokenData: TokenData | null }) {
  ...
  return <div ref={rootRef} className="relative z-40 px-2 pt-2 sm:px-4 sm:pt-3">
    ...
    {panel && <div className="shell-panel absolute right-2 mt-2 max-h-[420px] w-[480px] max-w-[calc(100vw-1rem)] overflow-y-auto rounded-2xl sm:right-4"><TokenUsage data={tokenData} /></div>}
  </div>;
}
